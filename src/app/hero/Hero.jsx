...
const Hero = () => {
  return (
    <>
        ...
        <div className="mt-8 lg:grid lg:grid-cols-2 lg:items-center lg:gap-4 lg:mt-16 xl:gap-14">
          <div>
            ...
            <p className="mb-6 xl:mb-8 xl:text-lg xl:leading-[27px]">
              ...
              they become a canvas for culinary artistry. At NoodleWonders, we
              are passionate about noodles, and our mission is to bring you the
              finest, most exquisite noodle creations you have ever tasted. Join
              us on a journey of flavor and texture, where each bite tells a
              story and every bowl is a masterpiece. Explore our menu, and
              prepare to fall in love with noodles all over again.
            </p>
      ...
      <div className="lg:absolute lg:top-0 lg:right-0 lg:h-screen lg:w-[30%] lg:bg-[#FF8800] lg:-z-10"></div>
    </>
  );
};
